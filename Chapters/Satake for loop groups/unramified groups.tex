\section{The case of unramified groups}
    \subsection{Affine Grassmannians}
        ...
        \subsubsection{The affine Grassmannian for \texorpdfstring{$\GL_n$}{}}
            ...
            \end{definition}
            \begin{remark}[Loop spaces as cofiltered limits of jet spaces] \label{remark: loop_spaces_as_cofiltered_limits_of_jet_spaces}
            ...
            \end{remark}
            \begin{remark}[Loop groups] \label{remark: loop_groups}
